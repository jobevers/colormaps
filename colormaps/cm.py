...
import colormaps
import colormaps.colors as colors
import colormaps.cbook as cbook
from colormaps._cm import datad, _deprecation_datad
from colormaps._cm import cubehelix
from colormaps._cm_listed import cmaps as cmaps_listed
...
LUTSIZE = colormaps.rcParams['image.lut']
...
def register_cmap(name=None, cmap=None, data=None, lut=None):
    ...
    In the first case, *cmap* must be a :class:`colormaps.colors.Colormap`
    instance.  The *name* is optional; if absent, the name will
    be the :attr:`~colormaps.colors.Colormap.name` attribute of the *cmap*.

    In the second case, the three arguments are passed to
    the :class:`~colormaps.colors.LinearSegmentedColormap` initializer,
    ...
    if lut is None:
        lut = colormaps.rcParams['image.lut']
...
def get_cmap(name=None, lut=None):
    ...
    If *name* is a :class:`colormaps.colors.Colormap` instance, it will be
    returned.
    ...
    """
    if name is None:
        name = colormaps.rcParams['image.cmap']
...
class ScalarMappable(object):
    ...
    def __init__(self, norm=None, cmap=None):
        ...
        Parameters
        ----------
        norm : :class:`colormaps.colors.Normalize` instance
            The normalizing object which scales data, typically into the
            interval ``[0, 1]``.
            If *None*, *norm* defaults to a *colors.Normalize* object which
            initializes its scaling based on the first data processed.
        cmap : str or :class:`~colormaps.colors.Colormap` instance
